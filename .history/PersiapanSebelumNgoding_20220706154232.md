...
3. **Buat folder baru di komputer Anda, misalnya di Desktop dengan nama `Codeblox`, lalu Buka Terminal (MacOS) atau Command Prompt (Windows), lalu tulis script berikut: `cd` yang merupakan singkatan dari create directory, atau membuat direktori**
