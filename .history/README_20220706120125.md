...
**Melalui dokumentasi ini, kami dengan segenap hati, menulis sebuah panduan yang mengandung informasi seputar langkah untuk mulai belajar koding dengan penjelasan yang mudah dipahami bagi teman-teman yang belum memiliki pengalaman ngoding ❤️**
...
1. Install program bernama Visual Studio Code di komputer Anda melalui link [ini](https://code.visualstudio.com/download)
   ![1657083527240](image/README/1657083527240.png)
...
5. Buat folder baru di komputer Anda, misalnya di Desktop dengan nama `Codeblox`
6. Di Terminal (MacOS) / Command Prompt (Windows), tulis script berikut: `cd`
7. Setelah `cd` ditulis, drag and drop folder baru Anda ke dalam Terminal / Command Prompt dan tekan `Enter`
8. Masih di dalam Terminal / Command Prompt, silahkan copy-paste-enter script `git clone -b playground git@github.com:codebloxedu/galileo.git`
9. Clone this repository or download to your local
10. Make sure you already install a live-server extension. In this case, I'm using `Five Server`
11. Run the project by using live-server in the `index.html` or tap the server URL in the footer
12. Your browser will opens and run your project instantly
