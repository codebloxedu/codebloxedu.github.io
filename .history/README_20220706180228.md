...
Untuk memahami FlowComponent, kamu bisa bayangkan aplikasi Gojek dimana di dalam halaman Gofood ada pilihan kategori kuliner seperti Western, Korean, Japanese, dan lainnya. Nah, pilihan kategori tersebut merupakan sekumpulan halaman, atau Page yang mengandung informasi yang beragam. Perbedaan signifikan antara FlowComponent dan PageComponent adalah kalau FlowComponent fokus di dalam 1 halaman. 

Contohnya, di dalam menu Gofood ada menu Western, dan ketika diklik maka muncul opsi makanan Western. Sedangkan kalau di PageComponent, misalnya di halaman utama aplikasi Gojek ada menu Gofood, Goride, Gomart dan lainnya, nah setiap halaman memiliki konteks yang berbeda
...
Itu sebabnya, dalam praktiknya, file Lottie akan terlebih dulu dirancang oleh animator, kemudian dikonversi menjadi file berbentuk .json. Setelahnya, kamu hanya perlu mengintegrasikan animasi tersebut di dalam projectmu. Untuk melihat contoh animasi Lottie, kamu bisa ketuk link [ini](https://lottiefiles.com/)
