...
6. Setelah `cd` ditulis, drag and drop folder baru Anda ke dalam Terminal / Command Prompt dan tekan `Enter`
...
8. Clone this repository or download to your local
9. Make sure you already install a live-server extension. In this case, I'm using `Five Server`
10. Run the project by using live-server in the `index.html` or tap the server URL in the footer
11. Your browser will opens and run your project instantly
